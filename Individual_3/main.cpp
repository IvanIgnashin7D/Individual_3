...
#include <iomanip>
	...
	std::cout << ellipse1->getname() << ' ';
	std::cout << ellipse1->getarea() << ' ';
	FrameRectangle ellipse1_FR_M = ellipse1->getFrameRectangle();
	std::cout << ellipse1_FR_M.getp().getx() - ellipse1_FR_M.getw() / 2.0 << ' ' << ellipse1_FR_M.getp().gety() - ellipse1_FR_M.geth() / 2.0 << ' ';
	std::cout << ellipse1_FR_M.getp().getx() + ellipse1_FR_M.getw() / 2.0 << ' ' << ellipse1_FR_M.getp().gety() + ellipse1_FR_M.geth() / 2.0 << '\n';
